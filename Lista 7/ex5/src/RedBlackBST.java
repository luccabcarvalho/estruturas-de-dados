...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
   ...
   //Complexidade O(1)
    private boolean isRed(Node x) {
        ...
        //caso o filho esquerdo seja maior, de acordo com os parâmetros da questão, o nó é vermelho
        if(cmp > 0)
            return true;
        else if(cmp < 0)
            return false;
    ...
    //Método para tornar o elo vermelho
    //Complexidade O(1)
    private void switchRedBlack(Node x)
    {
        Node aux = x.left;
        x.left = x.right;
        x.right = aux;
