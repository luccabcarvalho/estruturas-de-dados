...
public class ListaCircular extends Lista
{
	...
	public ListaCircular merge(ListaCircular lista2)
	{
		...
		do
		{
			...
			//determina o primeiro elemento da lista 3
			if(lista3.prim == null)
				lista3.prim = n1;

			//aponta último elo do looping anterior para o primeiro do looping atual
			if(n2 != null)
				n2.prox = n1;
			...
			//armazena o último elo da lista
			if (q != null)
				ult = n2;
		...
		//aponta o último elo para o primeiro, garantindo o caráter circular da lista
		ult.prox = lista3.prim;
